...
t("inferencia: 'Depilación Láser 10 sesiones' → 10 sesiones", core.inferDepilacionLaserService("Depilación Láser 10 sesiones")?.sessions_quantity === 10)
t("inferencia: 'Depilación Láser  4 Sesiones' → 4 sesiones", core.inferDepilacionLaserService("Depilación Láser  4 Sesiones")?.sessions_quantity === 4)
t("inferencia: 'Depilación Láser 100 sesión' → 100 sesiones", core.inferDepilacionLaserService("Depilación Láser 100 sesión")?.sessions_quantity === 100)
t("inferencia: consent_type depilacion-laser", core.inferDepilacionLaserService("Depilación Láser 5 sesiones")?.consent_type === "depilacion-laser")
t("inferencia: 'Masajes Relajantes M-1' → null (requiere mapeo)", core.inferDepilacionLaserService("Masajes Relajantes M-1") === null)

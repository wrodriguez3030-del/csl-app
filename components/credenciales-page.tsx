      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-h-[92vh] w-[96vw] max-w-[1280px] overflow-y-auto rounded-[28px] border-slate-200 bg-white text-slate-950">
          ...
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div><Label>Contraseña <span className="text-red-500">*</span></Label><Input className="mt-2 rounded-xl border-slate-200 bg-slate-50 text-slate-950" value={form.contrasena} onChange={(e) => setForm({ ...form, contrasena: e.target.value })} /></div>

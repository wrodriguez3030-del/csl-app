...
const EXTRA_GROUPS: { label: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "comision-sin-prestador", label: "Ventas sin prestador", icon: <UserX className="h-4 w-4" /> },
  ...
  {
    label: "BI Financiero IA",
    items: [
      { id: "bi-fin-dashboard", label: "Dashboard financiero", icon: <LayoutDashboard className="h-4 w-4" /> },
      { id: "bi-fin-asistente", label: "Asistente IA", icon: <BrainCircuit className="h-4 w-4" /> },
      { id: "bi-fin-ventas", label: "Ventas e ingresos", icon: <TrendingUp className="h-4 w-4" /> },
      { id: "bi-fin-gastos", label: "Gastos y egresos", icon: <Wallet className="h-4 w-4" /> },
      { id: "bi-fin-rentabilidad", label: "Rentabilidad por sucursal", icon: <Building2 className="h-4 w-4" /> },
      { id: "bi-fin-proyecciones", label: "Proyecciones", icon: <LineChart className="h-4 w-4" /> },
      { id: "bi-fin-inversiones", label: "Inversiones y ROI", icon: <PiggyBank className="h-4 w-4" /> },
      { id: "bi-fin-alertas", label: "Alertas financieras", icon: <Bell className="h-4 w-4" /> },
      { id: "bi-fin-reportes", label: "Reportes ejecutivos", icon: <BarChart3 className="h-4 w-4" /> },
      { id: "bi-fin-config", label: "Configuración IA", icon: <Cog className="h-4 w-4" /> },
    ],
  },
  {

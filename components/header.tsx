...
const pageMeta: Partial<Record<TabId, { title: string; description: string; eyebrow: string }>> = {
  ...
  "admin-agendapro": { title: "Integración AgendaPro", description: "Webhook de pagos, mapeos de sucursal/servicio y monitor de eventos", eyebrow: "Administración" },
  ...
  "comision-finanzas": { title: "Dashboard financiero", description: "Ventas, gastos, margen y rentabilidad por sucursal y servicio", eyebrow: "Incentivos de Ventas" },
  "comision-rentabilidad": { title: "Rentabilidad y flujo", description: "Margen por sucursal, flujo de efectivo mensual y retiros de socios", eyebrow: "Incentivos de Ventas" },
  "comision-analisis": { title: "Análisis IA", description: "Análisis financiero y recomendaciones sobre los datos reales del período", eyebrow: "Incentivos de Ventas" },
  ...
  "req-mat-nueva": { title: "Nueva requisición", description: "Solicitud de materiales por sucursal", eyebrow: "Requisición de materiales" },
  "req-mat-mis": { title: "Mis requisiciones", description: "Seguimiento de tus requisiciones y su estado", eyebrow: "Requisición de materiales" },
  ...
  "compras-dashboard": { title: "Dashboard de compras", description: "Compras, pagos, balances y vencimientos del mes", eyebrow: "Compras" },
  "compras-facturas": { title: "Facturas de proveedores", description: "Registro de facturas, detalle, pagos y adjuntos", eyebrow: "Compras" },
  "compras-pagos": { title: "Pagos / gastos", description: "Registro general de pagos y gastos operativos", eyebrow: "Compras" },
  "compras-gastos-menores": { title: "Gastos menores", description: "Caja chica: registrar, aprobar y pagar", eyebrow: "Compras" },
  "compras-recurrentes": { title: "Pagos recurrentes", description: "Compromisos periódicos y sus próximos vencimientos", eyebrow: "Compras" },

  ...
  return (
    <div className="space-y-6">
      ...
      <div className="no-print flex items-center justify-between gap-3">
        <div>
          <h2 className="flex items-center gap-2 text-xl font-bold"><Gift className="h-5 w-5 text-primary" />CF de Regalo para imprimir</h2>
          <p className="text-sm text-muted-foreground">Coloca el certificado fisico en la impresora. Se imprimiran solo los campos y el QR.</p>
        </div>
